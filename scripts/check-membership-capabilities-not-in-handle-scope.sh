...
NAMES="list_principals create_principal add_member set_principal_role rotate_api_key disable_principal get_workspace list_models list_grants list_policies list_quotas list_gatekeepers get_gatekeeper list_operations get_agent_profile set_agent_profile get_agent_policy set_agent_policy platform_overview list_users create_user update_user set_user_status reset_user_password list_user_memberships add_membership set_membership_role remove_membership merge_user set_user_budget get_platform_settings update_platform_settings platform_audit_query list_workspaces list_platform_models create_workspace update_workspace set_workspace_status set_allowed_models list_connectors set_connector_mode list_gate_instances get_gate_instance update_gate_instance test_gate_instance list_external_runtimes revoke_external_runtime list_available_gate_instances enable_gate_instance issue_service_handle create_gate_instance delete_gate_instance issue_gate_host_token issue_gate_credential_token purge_workspace purge_user issue_llm_admin_token"
