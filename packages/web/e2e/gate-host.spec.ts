 ...
 *  `integrations.spec.ts`'s own helper of the same name and shape (console redesign UX inversion,
 *  production incident 2026-09-26: checked means "the agent may call it", the opposite of this
 *  helper's own `disabled` parameter; newly disabling one opens a confirm). Assumes the connector's
